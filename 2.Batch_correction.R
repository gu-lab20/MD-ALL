...
# load("/scratch/zuhu/project/ZhaohuiGu/B-ALL_subtyping/R_code/2.prepare_matrix/2.data_temp/vst_gene_2239.rdata")
...
#Arguments -------------
vst_list="/scratch/zuhu/project/ZhaohuiGu/B-ALL_subtyping/out_new/stats/GEP_prediction/vst.list"
id_info="/scratch/zuhu/project/ZhaohuiGu/B-ALL_subtyping/id/df_batch.tsv"
