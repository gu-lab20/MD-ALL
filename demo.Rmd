...
mutation1=BALL.mutation %>% filter(gene=="JAK2")
...
df_out_test=run_one_sample(sample_id = "COH000333_D1.5M",file_count = "out_raw/COH000333_D1.5M/TRANSCRIPTOME/HTSeq/COH000333_D1.5M.DUX4patched.HTSeq",
               file_vcf = "out_raw/COH000333_D1.5M/TRANSCRIPTOME/Mutation/COH000333_D1.5M.HaplotypeCaller.vcf",
               file_fusioncatcher = "out_raw/COH000333_D1.5M/TRANSCRIPTOME/FusionCatcher/final-list_candidate-fusion-genes.txt",
