...
from_vst2tsnePanel_df=function(df_in,diag_in){
  ...
  df_vst_batchC=correct_batch(df_in,diag_in,"COH_sample")
  print("codingNoXYM")
  ...
  print("top MAD10000")
  df_vst_batchC_codingNoXYM_highE_MAD3000=get_high_MAD_gene(df_vst_batchC_codingNoXYM_highE,10000)
  print("remove corr")
  df_vst_batchC_codingNoXYM_highE_MAD3000_noCorr=remove_high_corr_genes(df_vst_batchC_codingNoXYM_highE_MAD3000,0.75)
  print("top MAD5000")
  df_vst_batchC_codingNoXYM_highE_MAD3000_noCorr_MAD5000=get_high_MAD_gene(df_vst_batchC_codingNoXYM_highE_MAD3000_noCorr,5000)
  print(dim(df_vst_batchC_codingNoXYM_highE_MAD3000_noCorr_MAD5000))
  df_vst_batchC_codingNoXYM_highE_MAD3000_noCorr_MAD5000
}
